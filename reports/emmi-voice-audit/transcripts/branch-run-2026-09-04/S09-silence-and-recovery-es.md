...
- started: 2026-09-04T19:54:58.562Z
- finished: 2026-09-04T19:57:20.572Z
...
| 2 | speech | APPOINTMENT_CONFIRMED | Hola. | Hola. | Hola. Estoy aquí para ayudarle con su cita. ¿Qué necesita? | 1824 | NOTICEABLE DELAY | 6039 |  | same view |  |
...
| 5 | speech | APPOINTMENT_CONFIRMED | Repítemelo. | Repítemelo. | Le decía que estoy aquí para ayudarle con su cita. | 1832 | NOTICEABLE DELAY | 6094 |  | same view | EMMI was not idle before the patient spoke (state USER_SPEAKING) |
...
```json
{
  "spoken_turns": 5,
  "total_turns": 8,
  "response_start_p50_ms": 1824,
  "response_start_p95_ms": 1832,
  "response_start_avg_ms": 1828,
...
- voice start: state EMMI_SPEAKING, socket true, error "", 703 ms after tap
